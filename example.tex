% Use \newif\if{{<level>}} to define boolean flags for each cumulative level,
% and explicitly set them all to false using \{{<level>}}false
...
\begin{document}
	...
	\begin{enumerate}
		...
		simule su llenado, y devuelva la cantidad \if{{2}}{de figuritas }\fi que se tuvieron que adquirir para completarlo.
		...
		necesarias para llenar el álbum\if{{3}}{ en cada simulación}\fi.
		\fi
	\end{enumerate}
\end{document}
